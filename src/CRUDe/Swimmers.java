...
public class Swimmers extends JFrame {
    Connection con;
    Statement stmt;
    ResultSet rs;
    int curRow = 0;
    ...
    public void DoConnect( ) {
        ...
        try {
            String host = "jdbc:jtds:sqlserver://sql6005.site4now.net/DB_A44BEF_ilimsky";
            String username = "DB_A44BEF_ilimsky_admin";
            ...
            String pOut =  id_col + " " + first_name + " " + last_name + " " + school;
            System.out.println(pOut);

        }
        catch (SQLException ex) {
            JOptionPane.showMessageDialog(Swimmers.this, ex.getMessage());
        }
    }
    ...
    private void initComponents() {
                ...
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addComponent(textFirstName, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(textLastName, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jLabel2.setText("Swimschool CRUD App");
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        try {
            if ( rs.next( ) ) {
                ...
                rs.previous( );
                JOptionPane.showMessageDialog(Swimmers.this, "End of File");
            }
        }
        catch (SQLException ex) {
            JOptionPane.showMessageDialog(Swimmers.this, ex.getMessage());
    ...
    private void btnPreviousActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPreviousActionPerformed
        try {
            if ( rs.previous( ) ) {
                ...
                rs.next( );
                JOptionPane.showMessageDialog(Swimmers.this, "Start of File");
            }
        }
        catch (SQLException ex) {
            JOptionPane.showMessageDialog(Swimmers.this, ex.getMessage());
    ...
    private void btnCancelNewRecordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelNewRecordActionPerformed
        try {
            ...
            textSchool.setText( rs.getString("School") );
    ...
    private void btnUpdateRecordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateRecordActionPerformed
        ...
        try {
            ...
            rs.updateRow( );
            JOptionPane.showMessageDialog(Swimmers.this, "Updated");
        }
        catch (SQLException err) {
            System.out.println(err.getMessage() );
        }
    ...
    private void btnSaveRecordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveRecordActionPerformed
        ...
        try {
            ...
            String school2 = rs.getString("School");

            textID.setText(id);
            textFirstName.setText(first2);
            textLastName.setText(last2);
            textSchool.setText(school2);
